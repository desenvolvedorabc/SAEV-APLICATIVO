...
export default function TableAdd({ listAdded, addItem, county }: Params) {
  ...
  const { data, isLoading } = useGetSchools({search: debouncedSearchTerm, page, limit: 6, column: null, order: 'ASC', active: "1", verifyExistsRegional: 1, county, typeSchool:'ESTADUAL', enabled: !!county});
